...
import mk.ukim.finki.finkiqa.payload.request.FacebookLogInRequest;
import mk.ukim.finki.finkiqa.payload.request.LogInRequest;
import mk.ukim.finki.finkiqa.payload.request.SignUpRequest;
import mk.ukim.finki.finkiqa.payload.response.JwtResponse;
import mk.ukim.finki.finkiqa.payload.response.MessageResponse;
...
public class AuthRestController {
    ...
    public  ResponseEntity<?> facebookAuth(@Valid @RequestBody FacebookLogInRequest facebookLoginRequest) {
        JwtResponse response = this.facebookService.loginUser(facebookLoginRequest.getAccessToken());
